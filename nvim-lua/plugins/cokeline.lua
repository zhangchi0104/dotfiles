...
local palette_util = require('tokyonight.util')
local rq_palette = require('tokyonight/colors').setup()
...
local components = {
  ...
  devicon = {
    ...
    hl = {
      fg = function(buffer)
        return
          (rq_mappings.is_picking_focus() and rq_palette.yellow)
          or (rq_mappings.is_picking_close() and rq_palette.red)
  ...
  close_or_unsaved = {
    ...
    hl = {
      fg = function(buffer)
        return buffer.is_modified and rq_palette.green or nil
      end
    },
